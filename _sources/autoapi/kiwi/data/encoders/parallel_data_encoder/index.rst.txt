:mod:`kiwi.data.encoders.parallel_data_encoder`
===============================================

.. py:module:: kiwi.data.encoders.parallel_data_encoder
...
.. autoapisummary::
   ...
   kiwi.data.encoders.parallel_data_encoder.InputFields
   kiwi.data.encoders.parallel_data_encoder.EmbeddingsConfig
   kiwi.data.encoders.parallel_data_encoder.VocabularyConfig
   kiwi.data.encoders.parallel_data_encoder.ParallelDataEncoder
...
.. py:class:: ParallelDataEncoder(config: Config, field_encoders: Dict[str, TextEncoder] = None)
   ...
   .. method:: fit_vocabularies(self, dataset: ParallelDataset)
