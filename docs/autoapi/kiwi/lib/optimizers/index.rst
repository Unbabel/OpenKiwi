:mod:`kiwi.lib.optimizers`
==========================

.. py:module:: kiwi.lib.optimizers
...
.. autoapisummary::
   ...
   kiwi.lib.optimizers.OptimizerConfig
   kiwi.lib.optimizers.DenseSparseAdam
...
.. autoapisummary::
   ...
   kiwi.lib.optimizers.get_noam_decay_schedule
   kiwi.lib.optimizers.optimizer_class
   kiwi.lib.optimizers.optimizer_name
   kiwi.lib.optimizers.from_config
...
.. py:class:: DenseSparseAdam(params: Iterable, lr: float = 0.001, betas: Tuple[float, float] = (0.9, 0.999), eps: float = 1e-08)

   Bases: :class:`torch.optim.optimizer.Optimizer`
   ...
   :param betas: coefficients used for computing running averages of gradient and its
                 square.
   :param eps: A term added to the denominator to improve numerical stability.

   .. method:: step(self, closure: Callable = None)
