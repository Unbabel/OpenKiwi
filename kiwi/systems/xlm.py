...
from kiwi.systems.encoders.xlm import XLMEncoder
...
class ModelConfig(BaseConfig):
    encoder: XLMEncoder.Config = XLMEncoder.Config()
    ...
    def __init__(
        ...
        if module_dict:
            ...
            self.data_encoders = WMTQEDataEncoder(
                ...
                field_encoders=XLMEncoder.input_data_encoders(
